...
--- | ---
Input Parsing and Information Extraction | Every statement entered by the user is tokenized, lemmatized and part-of-speech tagged. Named-Entity Recognition will also be done.
...
![Database Diagram](img_proposal/db.jpg)
